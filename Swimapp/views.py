...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            ...
            return render(request, 'mysite/register_done.html', {'new_user': new_user})
    else:
...
def search_results(request):
    ...
    return render(request, 'mysite/search_results.html', context)
...
def spot_detail(request, spot):
    ...
    return render(request, 'mysite/spot.html', context)
...
def edit_swimming_spot(request, spot_id):
    ...
    return render(request, 'mysite/edit_swimming_spot.html', {'form': form})
...
def delete_spot(request, spot_id):
    ...
    return render(request, 'mysite/confirm_delete.html', context)
...
def my_spots(request):
    ...
    return render(request, 'mysite/my_spots.html', context)


@login_required
def community(request):
    feed_items = FeedItem.objects.order_by('-created')[:100]  # You might want to limit or filter the items
    return render(request, 'mysite/community.html', {'feed_items': feed_items})
